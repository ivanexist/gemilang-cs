    ...
    <div className="flex flex-col sm:mb-16 md:mb-0 sm:py-0 md:py-16 bg-white">
      <div className="grid sm:grid-cols-1 md:grid-cols-3 max-w-screen-xl mx-auto text-center">
        ...
        <div className="flex flex-col sm:my-4 lg:my-0">
          ...
          <div>
            <h2 className="my-6 font-bold text-blue-600 font-PlayfairDisplay text-center text-lg">
              Kualitas Terbaik
            </h2>
          </div>
          <div>
            <p className="text-left px-10 text-masala-800 font-openSans font-light">
        ...
        <div className="flex flex-col sm:my-4 lg:my-0">
          ...
          <div>
            <h2 className="my-6 font-semibold text-blue-600 font-PlayfairDisplay text-center text-lg">
              Tepat Waktu
            </h2>
          </div>
          <div>
