...
export default async function ServicesContent() {
  ...
  return (
    <div className="flex flex-col pb-24 overflow-hidden bg-[url('https://euildint.vercel.app/assets/images/testimonial/testi-bg.jpg')] bg-cover bg-center bg-no-repeat">
      <div className="max-w-screen-xl w-full mx-auto px-4 py-8 mb-4 text-center">
      ...
      <div className="max-w-screen-xl w-full mx-auto bg-blue-600 mt-12 rounded-lg text-white">
        <div className="p-8 flex flex-col">
          ...
          <div className="flex justify-center mt-4">
            <button className="px-4 py-2 border rounded-lg bg-white text-blue-600 font-semibold mt-4 mr-4 hover:bg-blue-600 hover:text-white transition duration-300">
              Konsultasi Gratis
            </button>
            <button className="px-4 py-2 border-2 rounded-lg bg-blue-600 text-white font-semibold mt-4 mr-4 hover:bg-white hover:text-blue-600 transition duration-300">
              Lihat Portfolio
            </button>
          </div>
        </div>
